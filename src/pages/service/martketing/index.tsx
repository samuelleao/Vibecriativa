...
export default function Marketing() {
    ...
    return (
        <Fragment>
            ...
            <Navbar />
            <header className="py-44 tablet:pb-20 tablet:pt-32 relative before:absolute before:h-full before:w-full before:bg-slate-950/70 before:top-0 before:left-0 before:z-[1]">
                <div className="container flex items-center justify-center tablet:flex-col notbook2:items-start ">
                    <div className="w-5/12 tablet:w-full flex flex-col items-center gap-8 justify-center relative z-[1] text-center">
                        ...
                        <div className="flex gap-4 mt-5 mobile:flex-col mobile:w-full">
                        <a href="#assessoria" className="block mobile:w-full">
                                <Button variant="white" className="w-full justify-between h-12">Assessoria <FaArrowDown /></Button>
                            </a>
                            <a href="#consultorias" className="block mobile:w-full">
                                <Button  variant="outline"  className="w-full justify-between h-12">Consultorias <FaArrowDown /></Button>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <section id="assessoria" className="py-32 tablet:py-16">
