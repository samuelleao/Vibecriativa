        ...
        <Fragment>
            ...
            <header className="pt-48 flex justify-center border-b-2 border-primary-500 overflow-hidden">
                <div className="max-w-[988px] text-center space-y-12 mb-20 tablet:px-4">
                    ...
                    <Image className="mb-[-25%_!important] shadow-xl" src={`${data?.service?.illustrationInternalPage}`} width={1240} height={540} alt={`Imagem ilustrando o serviço de ${data?.service?.title}`} />
                </div>
            </header>
            <main>
